...
\item $v^r: \nat \times \nat \to \real$ be a function s.t. $v^r(v^{+}, v^{-}) \triangleq \frac{v^{+}}{v^{-}}$ where $v^{+}, v^{-} \in \mathbb{N}$,
\item $v^t: \nat \times \nat \to \nat$ be a function s.t. $v^t(v^{+}, v^{-}) \triangleq v^{+} + v^{-}$ where $v^{+}, v^{-} \in \mathbb{N}$, 
\item 
\begin{itemize}
...
\item $p_{\mathcal{A}}: 2^\args \to 2^{\nat \times \nat}$ be a function s.t. $p_{\mathcal{A}}(\mathcal{B}) = \{\varg(a)$ $|$ $a \in \mathcal{B}\}$ where $\mathcal{B} \subseteq \args$
\item $\tau(a, \mathcal{B}) \triangleq \tau(V_{\mathcal{A}}(a), p_{\mathbb{A}}(\mathcal{B}))$ denote the social support for an argument $a$ via utilizing a vote aggregation function $\tau$ (where $\mathcal{B} \subseteq \args$),
\item
\begin{itemize}
...
\item $p_{\mathcal{R}}: 2^\att \to 2^{\nat \times \nat}$ be a function s.t. $p_{\mathcal{R}}(\mathcal{T}) = \{\vatt((a, b))$ $|$ $(a, b) \in \mathcal{T}\}$ where $\mathcal{T} \subseteq \att$,
\item $\tau((a, b), \mathcal{T}) \triangleq \tau(V_{\mathcal{R}}((a, b)), p_{\mathcal{R}}(\mathcal{T}))$ denote the social support for an attack relation between arguments  $a$ and $b$ via utilizing a vote aggregation function $\tau$ (where $\mathcal{T} \subseteq \att$),
...
[c]{lll}
0 &  & v_{max}=0\\
\frac{v^{+}}{v^{+}+v^{-}+\frac{1}{max(\mathcal{X})}} &  & \text{otherwise}%
\end{array}
\right.
\]
