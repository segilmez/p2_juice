...
%\item $v^r(\vargpro a, \vargcon a) = \frac{\vargpro a}{\vargcon a}$ denote the ratio of positive votes to negative votes for argument $a$,
...
%\item $v^t(\vargpro a, \vargcon a) =\vargpro a + \vargcon a$ denote the total number of votes for argument $a$,
...
\item $\tau(a) \triangleq \tau(V_{\mathcal{A}}(a), v_{emax})$ denote the social support for an argument $a$ via utilizing a vote aggregation function $\tau$,%\tau(\vargpro a, \vargcon a, \vargtot a)
\item
\begin{itemize}
...
\item $\tau((a, b)) \triangleq \tau(V_{\mathcal{R}}((a, b)), v_{rmax})$ denote the social support for an attack relation between arguments  $a$ and $b$ via utilizing a vote aggregation function $\tau$,%\tau(\vargpro a, \vargcon a, \vargtot a)
...
M(a) &= \tau(a) \tupd \neg \Tatt_{a_i \in \attackers a} ((\tau((a_i, a)) \tupd M(a_i)) \\
     &= \top \tupd \neg \left ((\tau((a_1, a)) \tupd M(a_1)) \tatt ... \tatt  ((\tau((a_i, a)) \tupd M(a_i)) \tatt ... \tatt  ((\tau((a_n, a)) \tupd M(a_n)) \right ) \\%\text{, being } a_i = b \in S \\
...
\begin{align*}
M(a) &= \tau(a) \tupd \neg \Tatt_{a_i \in \attackers a} ((\tau((a_i, a)) \tupd M(a_i)) \\
\bot  &= \top \tupd \neg \left ((\tau((a_1, a)) \tupd M(a_1)) \tatt ... \tatt  ((\tau((a_n, a)) \tupd M(a_n)) \right ) \\%\text{, being } a_i = b \in S \\
